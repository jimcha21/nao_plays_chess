...
#include "ar_track_alvar/ChessVector.h"
#include "ar_track_alvar/ChessPoint.h"
...
void chessboardVectorTopic(const ar_track_alvar::ChessVector& data){
  cv::Point pt;
...
public:
  ...
  void imageCb(const sensor_msgs::ImageConstPtr& msg)
  {
      ...
      vector<Vec4i> lines;
      HoughLinesP(dst, lines, 1, CV_PI/180, hough_thres, 50, 10 );
      ...
      for( size_t i = 0; i < lines.size(); i++ )
      {
          ...
          //line( src_gray, Point(l[0], l[1]), Point(l[2], l[3]), Scalar(0,0,255), 3, LINE_AA);
      }
